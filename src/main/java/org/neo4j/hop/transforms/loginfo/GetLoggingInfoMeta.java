...
public class GetLoggingInfoMeta extends BaseTransformMeta implements ITransformMeta<GetLoggingInfo, GetLoggingInfoData> {
  ...
  @Override
  public GetLoggingInfo createTransform( TransformMeta transformMeta, GetLoggingInfoData data, int copyNr,
