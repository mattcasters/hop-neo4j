...
public class GetLoggingInfoDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  private void ok() {
    ...
    try {
      ...
      new ErrorDialog( shell,
        ...
        BaseMessages.getString( PKG, "GetLoggingInfoDialog.ErrorParsingData.DialogMessage" ), e );
    }
    dispose();
  }
  ...
  private void preview() {
    try {
      ...
      new ErrorDialog(
        shell, BaseMessages.getString( PKG, "GetLoggingInfoDialog.ErrorPreviewingData.DialogTitle" ), BaseMessages
          .getString( PKG, "GetLoggingInfoDialog.ErrorPreviewingData.DialogMessage" ), e );
    }
  }
}