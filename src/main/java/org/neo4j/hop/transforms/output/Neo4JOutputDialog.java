...
public class Neo4JOutputDialog extends BaseTransformDialog implements ITransformDialog {
  ...
  public String open() {
    ...
    wlTransformName.setText( BaseMessages.getString( PKG, "Neo4JOutputDialog.StepName.Label" ) ); //$NON-NLS-1$
      ...
      if ( r != null && !r.isEmpty() ) {
        switch ( button ) {
          ...
          case 0:
            ...
            break;
          case 1:
            BaseTransformDialog.getFieldsFromPrevious( r, wFromPropsGrid, 1, new int[] { 1, 2 }, new int[] {}, -1, -1,
          ...
          case 2:
            ...
            break;
          case 3:
            BaseTransformDialog.getFieldsFromPrevious( r, wToPropsGrid, 1, new int[] { 1, 2 }, new int[] {}, -1, -1,
              ( item, valueMeta ) -> getPropertyNameTypePrimary( item, valueMeta, new int[] { 2 }, new int[] { 3 }, 4 )
            );
            break;
          case 4:
            BaseTransformDialog.getFieldsFromPrevious( r, wRelPropsGrid, 1, new int[] { 1, 2 }, new int[] {}, -1, -1,
              ( item, valueMeta ) -> getPropertyNameTypePrimary( item, valueMeta, new int[] { 2 }, new int[] { 3 }, 4 )
            );
            break;
        }
